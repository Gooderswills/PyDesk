      ...
      {"id": "1155",
       ...
       {"id": "1243",
        ...
        {"id": "1765",
         ...
         "correct_option": "option_2",
         "success_message": "You check the recent backups, find that an intern deleted the sales report, you restore it and sales can now access it",
         ...
         {"id": "1856",
          ...
          {"id": "1867",
           ...
           {"id": "1888",
            ...
            "correct_option": "option_1",
            "success_message": "You check the disk space, find that it is full and remove unnecessary files, Charlie's files can now be saved",
               ...
               {"id": "2009",
                ...
                {"id": "2020",
                 ...
                 {"id": "2021",
                  ...
                  "option_1": "Check if business server is down, restart if needed",
                  ...
                  {"id": "2023",
                   ...
                   "option_1": "Check if the printer is connected to the network, reconnect if needed",
                   "option_2": "Check if the user has the correct permissions, update if needed",
                   "correct_option": "option_1",
                       ...
                       {"id": "2038",
                        ...
                        {"id": "2040",
                         ...
                         {"id": "2048",
                          ...
                          "option_1": "Reset Brian's permissions so he has access to the cases",
                          ...
                          "fail_message": "You email Brian's boss, who is not happy, he sends Brian the cases but he still cannot access them",
                          "time_taken": 0.5
                          },
                          {"id": "2052",
                           "user": "Ben; Legal",
                           ...
                           "correct_option": "option_2",
                           "success_message": "You send Ben a magic link, he verifies it is him and then you reset his password, he can now access his account again",
